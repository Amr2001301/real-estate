...
android {
    namespace = "com.realestate.staff.mobile_staff"
    ...
    defaultConfig {
        ...
        // (e.g. `com.<brand>.staff`). Cannot be changed after first Play upload.
        applicationId = "com.realestate.staff.mobile_staff"
