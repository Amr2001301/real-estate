...
/// App-wide unread-notification count for the badge. Loaded on sign-in and
/// refreshed after the user reads notifications. Errors are swallowed (a badge
/// is non-critical) and reported via [AppLog].
