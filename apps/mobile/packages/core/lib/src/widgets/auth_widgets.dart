...
// Navy depth constants — shared Devora design language.
...
/// Premium navy hero header for auth screens.
///
/// Layout: optional back button pinned to top-end → brand mark centered →
/// eyebrow label → title → subtitle → gold accent line.
      ...
      child: DecoratedBox(
        ...
        child: Stack(
          children: [
            ...
            // Secondary gold bloom — bottom-start
            PositionedDirectional(
              bottom: -20,
              start: -40,
              child: Container(
...
/// A centred footer link with a tiny gold spark accent preceding the text.
