      ...
      <div className="relative bg-surface border border-hairline rounded-[20px] shadow-soft overflow-hidden">
        ...
        <div className="px-7 sm:px-9 pt-8 pb-7">
          <nav className="flex items-center gap-1.5 text-[12px] text-slate-400 mb-3">
            ...
            <span>/</span>
            <Link href="/dashboard/projects" className="hover:text-navy transition-colors">المشاريع</Link>
            <span>/</span>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-navy">{`تعديل: ${tx(project.name)}`}</h1>
              <p className="text-sm text-slate-500 mt-1">حدّث بيانات المشروع. التغييرات تطبق فور الحفظ.</p>
            </div>
