...
export function ContractPdfPanel({ contract, locale = 'ar' }: { contract: Contract; locale?: Locale }) {
  ...
  return (
    <PremiumSectionCard title={m.sectionContractFile} icon={<FileText />}>
      <div className="space-y-4">
        ...
        />
        {pending && (
          <p className="text-xs text-slate-400">{m.contractFileLinking}</p>
        )}
        {error && (
