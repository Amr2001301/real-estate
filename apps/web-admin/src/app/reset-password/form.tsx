    ...
    return (
      <div className="space-y-4">
        ...
        <Link
          ...
          className="flex h-[52px] w-full items-center justify-center rounded-xl bg-navy text-sm font-bold text-white shadow-soft transition-colors hover:bg-navy-700"
        >
          طلب رابط جديد
        </Link>
      </div>
