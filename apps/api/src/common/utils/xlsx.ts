...
// ── Brand + palette (ARGB) ───────────────────────────────────────────────────
export const XLSX_BRAND = 'Real Estate Admin';
...
/** Standard footer line: "Generated by Real Estate Admin". */
 ...
 * header.
 */
export function addBoardBanner(ws: Worksheet, title: string, span: number): void {
