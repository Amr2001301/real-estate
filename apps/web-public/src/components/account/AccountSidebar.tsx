 ...
 * row above a horizontally-scrolling nav.
 */
export function AccountSidebar({ fullName, roleLabel }: { fullName?: string; roleLabel: string }) {
              ...
              <Link
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'text-ink-muted hover:bg-navy/[0.05] hover:text-ink-strong',
                )}
              >
