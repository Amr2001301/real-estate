...
export function ProjectShowcaseCard({ project }: { project: PublicProjectListItem }) {
  ...
  return (
    <Link
      ...
      className="group relative block h-full overflow-hidden rounded-3xl shadow-card outline-none focus-visible:ring-2 focus-visible:ring-gold-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-6">
        ...
        <div className="mt-4 flex items-center justify-between">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-xs font-medium text-white backdrop-blur">
            ...
            {formatNumber(project.availableUnitsCount)} وحدة متاحة
          </span>
